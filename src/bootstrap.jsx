...
import {
  ...
  mergeConfig, APP_CONFIG_INITIALIZED,
} from '@edx/frontend-platform';
import { COMPONENT_PLUGIN, PluginSlot } from '@edx/frontend-platform/plugins';
      ...
      <PathFixesProvider>
        <NoticesProvider>
          <UserMessagesProvider>
            <Switch>
              <PageRoute path="/u/:username">
                <PluginSlot id="profile" fallback={<div>fallback</div>} />
              </PageRoute>
              <PageRoute path="/account/settings">
                <PluginSlot id="account" fallback={<div>fallback</div>} />
              </PageRoute>
...
subscribe(APP_CONFIG_INITIALIZED, () => {
  mergeConfig({
    ...
    //     plugins: [
    //       {
    //         url: 'http://localhost:1995/remote.js',
    ...
    //     plugins: [
    //       {
    //         url: 'http://localhost:1997/remote.js',
    //         type: COMPONENT_PLUGIN,
    //         scope: 'account',
    //         module: './app',
    //       },
